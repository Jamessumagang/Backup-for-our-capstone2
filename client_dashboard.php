...
$projects = [];
$sql = "SELECT project_id, project_name, project_type, start_date FROM projects ORDER BY start_date DESC";
        ...
        <table>
            ...
            <tbody>
                <?php if (count($projects) > 0): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="4" class="no-projects">No projects found.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
