...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        if ($stmt->execute()) {
            // Redirect back to the dashboard or project list after successful deletion
            header("location: dashboard.php"); // Or project_list.php
            exit();
        } else {
    ...
    // header("location: dashboard.php"); // Optional: redirect back
    // exit();
}
?> 