    ...
    <div class="container">
        <nav class="sidebar">
            <ul>
                ...
                <li class="dropdown <?php echo (basename($_SERVER['PHP_SELF']) == 'position.php' || basename($_SERVER['PHP_SELF']) == 'project_division.php' || basename($_SERVER['PHP_SELF']) == 'project_team.php') ? 'active' : ''; ?>">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="<?php echo (basename($_SERVER['PHP_SELF']) == 'project_division.php') ? 'active' : ''; ?>"><a href="project_division.php"><i class="fa fa-sitemap"></i> Project Division</a></li>
        ...
        <main class="main-content">
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<a href=\"delete_project.php?id=" . $row["project_id"] . "\" class=\"action-btn delete-btn\">Delete</a>";
                    echo "</td>";
                    echo "</tr>";
                }
