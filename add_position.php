...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($position_name) && !empty($daily_rate)) {
        $stmt = $conn->prepare("INSERT INTO positions (position_name, daily_rate) VALUES (?, ?)");
        $stmt->bind_param("sd", $position_name, $daily_rate);

        if ($stmt->execute()) {
            $message = "<div class=\"alert success\"><i class=\"fa fa-check-circle\"></i> New position added successfully!</div>";
        } else {
            ...
            <div class="form-container">
                ...
                <form action="add_position.php" method="POST">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Add Position</button>
                    </div>
                </form>
            </div>
        </main>
