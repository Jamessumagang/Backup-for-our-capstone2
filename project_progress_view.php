...
<head>
    ...
    <style>
        body {
            background: url('images/background.webp') no-repeat center center fixed, linear-gradient(135deg, #e0e7ff 0%, #f8fafc 100%);
...
<body>
    ...
    <script>
        // Generate distinct colors for each bar, with a special color for Total
        const barColors = [
            '#2563eb', '#f59e42', '#22c55e', '#ef4444', '#a855f7', '#fbbf24', '#0ea5e9', '#e11d48', '#10b981', '#f472b6', '#ffb347'
        ];
        ...
        // Assign colors, last bar (Total) is orange
        const backgroundColors = labels.map((l, i) => i === labels.length - 1 ? '#ffb347' : barColors[i % (barColors.length - 1)]);
