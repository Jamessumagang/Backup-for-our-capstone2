...
<div class="container">
    ...
    <div class="tabs">
        <a href="?status=Active&page=1&per_page=<?= $records_per_page ?>&search=<?= urlencode($search) ?>"><button class="tab <?= $status=='Active'?'active':'' ?>">Active</button></a>
        <a href="?status=Inactive&page=1&per_page=<?= $records_per_page ?>&search=<?= urlencode($search) ?>"><button class="tab <?= $status=='Inactive'?'active':'' ?>">Inactive</button></a>
    </div>
